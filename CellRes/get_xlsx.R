...
library(ASNJ)
homepage <- get_journal_homepage('Cell Research')    # Cell Research, Cell Discovery, STTT
homepage
...
writexl::write_xlsx(all_paper_metrics,'../ASNJ_data/CellRes/CellRes_paper_metrics.xlsx')
